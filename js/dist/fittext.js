 ...
 */
export function fitText(element, minFontSizePx, maxFontSizePx) {
    const compressor = 1;
    ...
    const resize = () => {
        const newFontSize = Math.max(Math.min(element.offsetWidth / (compressor * 10), maxFontSize), minFontSize);
